...
#teste com temperaturas para preencher nulos com o valor anterior
'''
...
#teste com temperaturas para preencher nulos com o valor posterior
'''
df_temperaturas = pd.DataFrame({
    "dia": ["Segunda", "Terça", "Quarta", "Quinta", "Sexta"],
    "temperatura": [30, np.nan, np.nan, 28, 27]
})
#preencher valores nulos com o valor posterior
df_temperaturas['preenchido_bfill'] = df_temperaturas['temperatura'].fillna(method='bfill')
'''

#teste com cidades para preencher nulos com o valor fixo
'''
